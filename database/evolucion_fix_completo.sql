...
CREATE TABLE public.coach_tasks (
    ...
    client_id UUID REFERENCES public.clientes_ado_notion(id) ON DELETE SET NULL, -- TIPO UUID
    title TEXT NOT NULL,
    description TEXT,
...
CREATE TABLE public.support_tickets (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    client_id UUID NOT NULL REFERENCES public.clientes_ado_notion(id) ON DELETE CASCADE,
