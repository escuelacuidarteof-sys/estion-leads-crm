...
-- 2. Crear el trigger
DROP TRIGGER IF EXISTS trigger_sync_client_status ON public.clientes_ado_notion;
...
ALTER TABLE public.clientes_ado_notion ALTER COLUMN property_estado_cliente SET DEFAULT 'Activo';
ALTER TABLE public.clientes_ado_notion ALTER COLUMN status SET DEFAULT 'active';
