...
-- ==============================================================================
-- ACTUALIZACIÓN EN LA TABLA DE CLIENTES (clientes_ado_notion)
-- ==============================================================================
-- Corregido: Usamos 'clientes_ado_notion' porque 'clients' no existe.
...
COMMENT ON COLUMN clientes_ado_notion.assigned_nutrition_type IS 'Tipo de plan asignado para hacer match automático con food_plans';
