...
-- This allows tracking ADO vs ME vs Global and more detailed financial/satisfaction metrics.
...
COMMENT ON COLUMN business_snapshots.project IS 'Project specific: Global, ADO or ME';
