...
ALTER TABLE public.clientes_ado_notion 
...
DROP POLICY IF EXISTS "Acceso Híbrido Clientes" ON public.clientes_ado_notion;
...
DROP POLICY IF EXISTS "Creación Onboarding" ON public.clientes_ado_notion;
...
DROP POLICY IF EXISTS "Staff ve todos los clientes" ON public.clientes_ado_notion;
