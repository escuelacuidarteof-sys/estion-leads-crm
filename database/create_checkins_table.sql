...
CREATE TABLE IF NOT EXISTS public.weekly_checkins (
    ...
    client_id TEXT NOT NULL, -- References the ID in your clients table (e.g. 'clientes_ado_notion')
    ...
    -- Optional: If you want to enforce Referential Integrity and your parent table is 'clientes_ado_notion'
    -- CONSTRAINT fk_client FOREIGN KEY (client_id) REFERENCES public.clientes_ado_notion(id) ON DELETE CASCADE
    -- Note: Only uncomment above if 'clientes_ado_notion' exists and 'id' types match (Text vs UUID etc)
