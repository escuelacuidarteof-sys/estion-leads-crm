...
import { Loader2, Lock, User, CheckCircle, AlertCircle, Eye, EyeOff } from 'lucide-react';
    ...
    const validateToken = async () => {
        ...
        try {
            const { data: client, error: clientError } = await supabase
                .from('clientes')
                .select('id, first_name, last_name, email, activation_token, user_id')
            ...
            <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 flex items-center justify-center p-4">
                <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                        Tu cuenta ha sido creada correctamente. Redirigiendo al portal...
                    </p>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">
                        Hola <strong>{clientData?.first_name}</strong>, crea tu contrasena para acceder al portal.
                    </p>
                </div>
                ...
                <p className="text-center text-sm text-gray-500 mt-6">
                    Al activar tu cuenta, podras acceder al portal de clientes de Escuela Cuid-Arte.
                </p>
            </div>
        </div>
    );
