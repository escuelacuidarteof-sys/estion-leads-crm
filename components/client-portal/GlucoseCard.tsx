...
import { Droplets, Plus, TrendingDown, TrendingUp, X, Clock, Utensils, Sunrise, Activity } from 'lucide-react';
...
export function GlucoseCard({ clientId }: GlucoseCardProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const { error } = await supabase
                ...
                .insert({
                    client_id: clientId,
                    glucose_value: parseFloat(newValue),
            ...
            alert('Error al guardar la glucemia');
        } finally {
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 hover:shadow-lg transition-shadow">
                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-rose-500 to-pink-600 flex items-center justify-center text-white shadow-lg shadow-rose-200">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                    <div className="text-center p-3 rounded-xl bg-slate-50">
                        ...
                        <p className={`text-xl font-bold ${isInTarget ? 'text-emerald-600' : 'text-rose-600'}`}>
                            {latestValue ?? '--'}
                        </p>
                    ...
                    <div className="text-center p-3 rounded-xl bg-slate-50">
                        ...
                        <div className="flex items-center justify-center gap-1">
                            ...
                            <span className={`text-sm font-bold ${trend === 'down' ? 'text-emerald-500' : trend === 'up' ? 'text-rose-500' : 'text-slate-400'}`}>
                    ...
                    <div className="h-40">
                        <ResponsiveContainer width="100%" height="100%">
                            <LineChart data={chartData} margin={{ top: 5, right: 5, left: -20, bottom: 0 }}>
                                ...
                                <ReferenceLine y={targetMax} stroke="#22c55e" strokeDasharray="3 3" strokeOpacity={0.5} />
                                <ReferenceLine y={targetMin} stroke="#22c55e" strokeDasharray="3 3" strokeOpacity={0.5} />
                                <Line
                                    type="monotone"
                                    dataKey="value"
                                    stroke="#f43f5e"
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-6">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full py-4 px-4 text-center text-3xl font-bold text-slate-900 border-2 border-slate-200 rounded-2xl focus:border-rose-500 focus:ring-4 focus:ring-rose-100 outline-none transition-all"
                                        value={newValue}
                            ...
                            <div className="mb-6">
                                ...
                                <input
                                    ...
                                    className="w-full py-3 px-4 border-2 border-slate-200 rounded-xl focus:border-rose-500 focus:ring-4 focus:ring-rose-100 outline-none transition-all"
                                    value={notes}
                            ...
                            <div className="space-y-3">
                                <button
                                    ...
                                    className="w-full py-4 bg-gradient-to-r from-rose-500 to-pink-600 text-white font-bold rounded-2xl shadow-lg shadow-rose-200 hover:shadow-xl disabled:opacity-50 transition-all active:scale-95"
                                >
