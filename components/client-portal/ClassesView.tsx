...
export function ClassesView({ onBack }: ClassesViewProps) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 animate-in fade-in duration-300">
            {/* Header */}
            <div className="bg-gradient-to-r from-purple-700 to-indigo-800 text-white shadow-lg sticky top-0 z-40">
                            ...
                            <div className="relative p-8 md:p-12 flex flex-col md:flex-row gap-8 items-center">
                                <div className="flex-1 space-y-6">
                                    ...
                                    <div className="pt-4">
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="inline-flex items-center gap-3 bg-white text-indigo-900 px-8 py-4 rounded-xl font-bold text-lg hover:bg-gray-100 transition-all hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.3)]"
                                        >
                                ...
                                <div className="w-full md:w-1/3 aspect-video md:aspect-square bg-gradient-to-br from-gray-700 to-gray-600 rounded-2xl flex items-center justify-center border border-white/10 shadow-inner relative overflow-hidden group">
                                    ...
                                    <div className="relative text-center p-6">
                                        <div className="w-20 h-20 bg-indigo-600 rounded-full flex items-center justify-center mx-auto mb-4 text-3xl font-bold text-white shadow-xl">
                                            {upcomingClass.speaker.charAt(0)}
                                        </div>
                                        <p className="text-white font-bold text-xl">{upcomingClass.speaker}</p>
                                        <p className="text-indigo-200">Coach Experto</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none w-full sm:w-64 transition-all"
                                value={searchTerm}
                        ...
                        <div className="flex gap-2 overflow-x-auto pb-2 sm:pb-0 scrollbar-hide">
                            <select
                                ...
                                className="px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-gray-700 font-medium focus:ring-2 focus:ring-purple-500 focus:border-purple-500 cursor-pointer hover:bg-gray-100 transition-colors"
                            >
                            ...
                            >
                                ...
                                <div className="relative aspect-video bg-gray-900 overflow-hidden">
                                    ...
                                    <div className="absolute top-4 left-4 flex gap-2">
                                        <span className={`px-2 py-1 rounded-lg text-xs font-bold text-white uppercase tracking-wide backdrop-blur-md ${session.category === 'Entrenamiento' ? 'bg-blue-500/80' :
                                            session.category === 'Nutrición' ? 'bg-green-500/80' : 'bg-purple-500/80'
                                            }`}>
                                            {session.category}
                                        </span>
                                    </div>
                                ...
                                <div className="p-6 flex-1 flex flex-col">
                                    ...
                                    <div className="mt-auto">
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className="flex items-center justify-center gap-2 w-full py-3 rounded-xl border-2 border-purple-100 text-purple-700 font-bold hover:bg-purple-50 hover:border-purple-200 transition-colors"
                                        >
