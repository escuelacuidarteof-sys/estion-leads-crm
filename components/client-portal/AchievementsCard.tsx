...
export function AchievementsCard({ clientId }: AchievementsCardProps) {
    ...
    return (
        <div className="bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 rounded-3xl p-6 border border-amber-100 hover:shadow-lg transition-shadow">
            {/* Header */}
                    ...
                    <div className="flex flex-wrap gap-3 mb-4">
                        ...
                        {allAchievements.length > 3 && (
                            <button
                                ...
                                className="w-16 h-16 rounded-2xl bg-white border-2 border-dashed border-slate-200 flex items-center justify-center text-slate-400 hover:border-amber-300 hover:text-amber-500 transition-colors"
                            >
                                +{allAchievements.length - 3}
                            </button>
                        )}
