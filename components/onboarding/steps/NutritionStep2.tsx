        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" required min="0" className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none" value={formData.eatsOutPerWeek} onChange={(e) => updateField('eatsOutPerWeek', parseInt(e.target.value))} />
                </div>
                <div>
