          ...
          {isDireccion ? (
            <>
              ...
              <MenuSection
                title="CRM Principal"
                icon={Building2}
                isOpen={expandedSections.includes('crm-principal')}
                onToggle={() => toggleSection('crm-principal')}
                show={true}
              >
            ...
            <>
              {/* MENÚ MÉDICO - Simplificado */}
              <MenuSection
                title="Mi Panel"
                icon={Stethoscope}
                isOpen={expandedSections.includes('doctor-panel')}
                onToggle={() => toggleSection('doctor-panel')}
                show={true}
              >
              ...
              <MenuSection
                title="Facturación"
                icon={Wallet}
                isOpen={expandedSections.includes('doctor-facturas')}
                onToggle={() => toggleSection('doctor-facturas')}
                show={true}
              >
              ...
              <MenuSection
                title="Comunicación"
                icon={MessageSquare}
                isOpen={expandedSections.includes('doctor-comunica')}
                onToggle={() => toggleSection('doctor-comunica')}
                show={true}
              >
