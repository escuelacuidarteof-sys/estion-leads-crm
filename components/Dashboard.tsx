...
const Dashboard: React.FC<DashboardProps> = ({ clients, user, onNavigateToClient, onRefreshData, onNavigateToView }) => {
   ...
   const [dueAlerts, setDueAlerts] = useState<{ tasks: any[], tickets: any[], rejectedInvoices: any[] }>({ tasks: [], tickets: [], rejectedInvoices: [] });
      ...
      try {
         ...
         if (client) {
            ...
            if (clientRow) {
               ...
               console.error('No se encontró el registro del cliente en clientes para la venta:', sale.id);
