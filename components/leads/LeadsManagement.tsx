...
import {
    ...
    Phone, Calendar, CheckCircle, XCircle, Users, TrendingUp,
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm p-4 rounded-2xl border border-slate-700/50">
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    >
                        ...
                        <option value="ADO" className="bg-slate-800">Escuela Cuid-Arte</option>
                                    ...
                                    return (
                                        <tr key={lead.notion_id} className="hover:bg-slate-700/30 transition-colors group">
                                            ...
                                            <td className="p-3 text-center">
                                                ...
                                                >
                                                    {lead.presentado ? <CheckCircle className="w-5 h-5" /> : <XCircle className="w-5 h-5" />}
                                                </button>
                                            </td>
                                            ...
                                            <td className="p-3 text-center">
                                                ...
                                                >
                                                    {lead.cierre ? <CheckCircle className="w-5 h-5" /> : <XCircle className="w-5 h-5" />}
                                                </button>
                                            </td>
