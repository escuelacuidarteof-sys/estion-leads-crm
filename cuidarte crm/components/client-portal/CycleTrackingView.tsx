...
function getPhaseInfo(dayInCycle: number, cycleLength: number) {
    ...
    if (dayInCycle <= Math.floor(cycleLength * 0.57)) return { name: 'Ovulación', color: 'text-blue-600', bg: 'bg-blue-50', border: 'border-blue-200', emoji: '🌕' };
    return { name: 'Lútea', color: 'text-amber-600', bg: 'bg-amber-50', border: 'border-amber-200', emoji: '🌙' };
}

export function CycleTrackingView({ client, onBack }: CycleTrackingViewProps) {
    ...
    const handleLogPeriod = async () => {
        ...
        try {
            ...
            await supabase.from('clientes').update({ last_period_start_date: periodStartDate }).eq('id', client.id);
    ...
    if (activeSection === 'log_symptoms') {
        ...
        return (
            <div className="max-w-lg mx-auto px-4 py-8 animate-in fade-in slide-in-from-bottom-4">
                ...
                <div className="bg-white rounded-3xl p-6 shadow-xl border border-pink-100">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="p-3 bg-purple-50 text-purple-600 rounded-xl"><SmilePlus className="w-6 h-6" /></div>
                        <div>
                    ...
                    <div className="space-y-5">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                max={new Date().toISOString().split('T')[0]}
                                className="w-full px-4 py-3 rounded-xl border-2 border-slate-200 focus:border-purple-400 focus:outline-none text-slate-700 font-medium"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-3 rounded-xl border-2 border-slate-200 focus:border-purple-400 focus:outline-none text-slate-700 resize-none h-20"
                            />
                        </div>
        ...
        <div className="max-w-2xl mx-auto px-4 py-8 animate-in fade-in slide-in-from-bottom-4">
                ...
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p className="text-pink-100 text-sm">
                            ...
                            {!hormonalStatus && 'Seguimiento hormonal'}
                        </p>
                    </div>
                </div>
            ...
            <div className={`grid ${isPreOrPeri ? 'grid-cols-2' : 'grid-cols-1'} gap-3 mb-6`}>
                ...
                <button
                    ...
                    className="flex items-center justify-between p-4 rounded-2xl bg-white shadow-md border border-purple-100 hover:shadow-lg transition-all group"
                >
                    <div className="flex items-center gap-3">
            ...
            {symptoms.length > 0 && (
                <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
                    <h3 className="text-sm font-bold text-slate-700 mb-4 flex items-center gap-2">
                        <Heart className="w-4 h-4 text-purple-500" /> Síntomas Recientes
                    </h3>
                    <div className="space-y-3">
                            ...
                            <div key={s.id} className="p-3 bg-slate-50 rounded-xl">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <div className="flex gap-1.5">
                                        ...
                                        {s.mood && <span className="text-[10px] bg-blue-100 text-blue-700 px-1.5 py-0.5 rounded-full font-bold">A:{s.mood}</span>}
                                        {s.sleep_quality && <span className="text-[10px] bg-indigo-100 text-indigo-700 px-1.5 py-0.5 rounded-full font-bold">S:{s.sleep_quality}</span>}
                                    </div>
                                </div>
                                <div className="flex flex-wrap gap-1">
                                    ...
                                    {s.night_sweats && <span className="text-[10px] bg-blue-200 text-blue-800 px-1.5 py-0.5 rounded-full font-bold">Sudores</span>}
                                </div>
