...
export function CheckinView({ client, onBack }: CheckinViewProps) {
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Header */}
            <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white pb-24">
                <div className="max-w-3xl mx-auto">
                    <button onClick={onBack} className="flex items-center gap-2 text-blue-100 hover:text-white transition-colors mb-6">
                        <ArrowLeft className="w-5 h-5" /> Cancelar
                    </button>
                    <h1 className="text-3xl font-bold mb-2">Check-in Semanal</h1>
                    <p className="text-blue-100 opacity-90">Tómate 5 minutos para reflexionar sobre tu semana. Esto ayuda mucho a tu coach.</p>
                </div>
            </div>
            ...
            <div className="max-w-3xl mx-auto -mt-16 px-6 pb-20">
                <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none h-24 resize-none"
                    ...
                    {step === 2 && (
                        <div className="p-8 animate-in slide-in-from-right duration-300">
                            <h3 className="text-xl font-bold text-slate-800 mb-6 flex items-center gap-3">
                                <Target className="w-6 h-6 text-blue-500" /> Feedback del Plan
                            </h3>
                    ...
                    {step === 3 && (
                        <div className="p-8 animate-in slide-in-from-right duration-300">
                            <h3 className="text-xl font-bold text-slate-800 mb-6 flex items-center gap-3">
                                <TrendingUp className="w-6 h-6 text-purple-500" /> Cierre y Peso
                            </h3>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <div className="flex items-center gap-4 bg-slate-50 p-4 rounded-xl border border-slate-200">
                                            ...
                                            />
                                            <span className="text-2xl font-bold text-blue-600 w-8 text-center">{answers.q6_nota}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full p-4 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none font-bold text-lg"
                                            placeholder="00.0"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between pt-4">
                                    ...
                                    <button
                                        ...
                                        className="px-8 py-3 bg-green-600 text-white rounded-xl font-bold hover:bg-green-700 flex items-center gap-2 shadow-lg shadow-green-200 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
