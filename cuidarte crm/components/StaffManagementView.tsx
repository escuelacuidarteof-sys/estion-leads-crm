    ...
    const handleMassReassign = async () => {
        ...
        try {
            ...
            const { error: error1 } = await supabase
                .from('clientes')
                .update({ coach_name: targetUser.name, coach_id: targetUser.id })
                .eq('coach_name', userToDelete.name);
