...
import {
    Users, Phone, Calendar, CheckCircle,
    ...
    return (
        <div className="p-4 md:p-8 max-w-[1600px] mx-auto space-y-6 bg-slate-50 min-h-screen">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <MetricCard title="Ventas Netas" value={stats.netClosed} subtitle={`Cierre Real: ${stats.netClosingRate}%`} icon={CheckCircle} color="emerald" />
            </div>
