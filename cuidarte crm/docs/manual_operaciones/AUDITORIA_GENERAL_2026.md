# 🕵️‍♂️ Auditoría General del Proyecto - Academia Diabetes Online CRM (2026)
...
Actualmente, las políticas de seguridad en base de datos (`seguridad_total_rls.sql`) definen una política **"Staff see all clients"** para la tabla `clientes_ado_notion`.
...
3.  **Backups:** Asegurar que hay copias de seguridad de la tabla `clientes_ado_notion` ya que contiene toda la lógica de negocio vital.
