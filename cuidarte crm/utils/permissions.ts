...
let ROLE_PERMISSIONS: Record<UserRole, string[]> = {
    ...
    [UserRole.HEAD_COACH]: [
        ...
        PERMISSIONS.MANAGE_MEDICAL, // Puede editar datos médicos
        PERMISSIONS.MANAGE_TEAM,
        PERMISSIONS.VIEW_SALES,
        PERMISSIONS.MANAGE_SETTINGS,
        PERMISSIONS.ASSIGN_COACH,
        PERMISSIONS.ACCESS_NUTRITION // Gestión de planes nutricionales
    ],
    [UserRole.COACH]: [
        PERMISSIONS.VIEW_CLASSES,
        PERMISSIONS.VIEW_MEDICAL, // Solo ve los suyos
        PERMISSIONS.MANAGE_MEDICAL, // Puede editar datos médicos de sus clientes
        PERMISSIONS.VIEW_RENEWALS,
        PERMISSIONS.ACCESS_NUTRITION // Gestión de planes nutricionales
    ],
    [UserRole.CLOSER]: [
