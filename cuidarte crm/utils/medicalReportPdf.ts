...
export function generateMedicalReportPdf(report: MedicalReportData, options: PdfOptions) {
  ...
  // Logo + Title row
  try {
    doc.addImage(APP_LOGO_BASE64, 'PNG', margin, y, 18, 18);
  } catch {
  ...
  doc.text('Escuela Cuid-Arte', margin + 22, y + 14);
  y += 25;
