...
COMMENT ON COLUMN public.clientes_ado_notion.f2_amount IS 'Amount paid for Phase 2 renewal';
COMMENT ON COLUMN public.clientes_ado_notion.f2_payment_method IS 'Payment method for Phase 2 (stripe, hotmart, etc.)';
COMMENT ON COLUMN public.clientes_ado_notion.f2_receipt_url IS 'URL of the receipt document for Phase 2';
