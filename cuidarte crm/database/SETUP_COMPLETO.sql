...
CREATE TABLE IF NOT EXISTS public.clientes_ado_notion (
...
CREATE INDEX IF NOT EXISTS idx_clientes_coach ON public.clientes_ado_notion(coach_id);
CREATE INDEX IF NOT EXISTS idx_clientes_status ON public.clientes_ado_notion(status);
CREATE INDEX IF NOT EXISTS idx_clientes_token ON public.clientes_ado_notion(onboarding_token);
...
CREATE TABLE IF NOT EXISTS public.sales (
    ...
    -- Referencias
    client_id UUID REFERENCES public.clientes_ado_notion(id),
...
DECLARE
    t TEXT;
BEGIN
    FOR t IN SELECT unnest(ARRAY['users', 'clientes_ado_notion', 'sales', 'app_settings', 'coach_invoices', 'support_tickets']) LOOP
...
ALTER TABLE public.clientes_ado_notion ENABLE ROW LEVEL SECURITY;
...
DROP POLICY IF EXISTS "Clientes: staff access" ON public.clientes_ado_notion;
CREATE POLICY "Clientes: staff access" ON public.clientes_ado_notion FOR ALL USING (public.is_staff());

DROP POLICY IF EXISTS "Clientes: self view" ON public.clientes_ado_notion;
CREATE POLICY "Clientes: self view" ON public.clientes_ado_notion FOR SELECT USING (user_id = auth.uid());

DROP POLICY IF EXISTS "Clientes: public insert onboarding" ON public.clientes_ado_notion;
CREATE POLICY "Clientes: public insert onboarding" ON public.clientes_ado_notion FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Clientes: public update onboarding" ON public.clientes_ado_notion;
CREATE POLICY "Clientes: public update onboarding" ON public.clientes_ado_notion FOR UPDATE USING (true);
