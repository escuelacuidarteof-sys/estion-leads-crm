...
-- Adaptado para: Academia Diabetes Online CRM
-- ==============================================================================
...
DROP POLICY IF EXISTS "Staff see all clients" ON public.clientes_ado_notion;
CREATE POLICY "Staff see all clients" ON public.clientes_ado_notion FOR ALL USING (public.is_staff());

DROP POLICY IF EXISTS "Clients see own profile" ON public.clientes_ado_notion;
CREATE POLICY "Clients see own profile" ON public.clientes_ado_notion FOR SELECT USING (id::text = auth.uid()::text OR user_id = auth.uid());

DROP POLICY IF EXISTS "Public insert during onboarding" ON public.clientes_ado_notion;
CREATE POLICY "Public insert during onboarding" ON public.clientes_ado_notion FOR INSERT WITH CHECK (true);

DROP POLICY IF EXISTS "Public update during onboarding" ON public.clientes_ado_notion;
CREATE POLICY "Public update during onboarding" ON public.clientes_ado_notion FOR UPDATE USING (true) WITH CHECK (true);
